...
export const Unicos = () => {
  return (
    <div className='max-w-5xl m-auto pt-16'>
        <h1 className='text-sm max-w-lg leading-10 mt-4 font-normal sm:mt-5 sm:text-3xl lg:mt-6 xl:text-3xl'>Cursos únicos</h1>
            <p className='mt-3 text-base sm:mt-5 sm:text-xl lg:text-base xl:text-base max-w-md'>
                Obten información y materiales especializados
                para que puedas obtener nuevas habilidades y
                mejorar tu curriculum profesional.
            </p>
            <Link href="/registro">
        ...
        <div className='flex flex-row gap-5'>
            <div className='cursos-card drop-shadow flex flex-col justify-start p-6 rounded w-96'>
            <img className='w-72 mr-6 rounded' src="https://www.skillum.mx/images/cursos-card1.png" alt="" />
            <ul class="tags flex justify-start leading-4 flex-wrap pt-5">
