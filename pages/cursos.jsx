    ...
    <Layout>
        <div className="pt-44">
            <section className='cursos-wrapper max-w-5xl my-0 mx-auto'>
                ...
                {/* Sidebar */}
                <div className='w-full sm:w-3/12 lg:w-2/12 pr-4 tex-left absolute inset-y-0 left-0 transform -translate-x-full md:relative md:translate-x-0 transition duration-200 ease-in-out z-40'>
                ...
                <div className='py-44'>
                    <h1 className='text-5xl pb-8'>Conoce más de Skillum</h1>
                    <div className='w-96 rounded overflow-hidden shadow-lg'>
                        <img className='max-w-xs mx-9 my-5 rounded' src="https://www.skillum.mx/images/cursos-card1.png" alt="" />
                            <div className='mx-4 my-5 flex'>
                                <img className='flex pb-4 mr-1' src="https://www.skillum.mx/images/miniatura.png" alt="" />
                                <p className='mt-2 font-normal text-slate-400'>Por Abel Arteaga</p>
                                <ul className="tags flex justify-start leading-4 flex-wrap">
                                    <li className="green-tag bg-green-300 text-green-700 flex mr-1 py-1 px-2.5 rounded-2xl text-sm font-semibold">Gratuito</li>
                                </ul>
                            </div>
                        <h3 className='mx-4 my-5 text-xl font-normal'>Descrube tu potencial de forma metódica</h3>
                        <p className='mx-4 my-5 text-sm font-normal text-slate-500'>
